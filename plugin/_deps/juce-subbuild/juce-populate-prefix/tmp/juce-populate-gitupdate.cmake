...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "8.0.2"
  WORKING_DIRECTORY "C:/Users/Mattias Simson/KoodJhvi/PLUGINS/audio-plugin-starter/audio-plugin-template/libs/juce"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("8.0.2" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/8.0.2")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"8.0.2\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Mattias Simson/KoodJhvi/PLUGINS/audio-plugin-starter/audio-plugin-template/libs/juce'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Mattias Simson/KoodJhvi/PLUGINS/audio-plugin-starter/audio-plugin-template/libs/juce'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
